...
public class PlayerQueries
{
    ...
    public static String getGoldAmountFromPlayer(Integer playerId)
    {
        return "SELECT 200 + monster_loot_gold + quest_reward_gold + gold_offer_gold - bought_pets_gold - bought_skins_gold " +
                ...
                "(SELECT SUM(gold_price) AS bought_skins_gold FROM " +
                ...
                "(SELECT SUM(gold_amount) AS quest_reward_gold FROM " +
                ...
                "(SELECT SUM(gold_amount) AS monster_loot_gold FROM " +
                ...
                "JOIN monster_loot ON monster.monster_loot_id = monster_loot.monster_loot_id)) AS players_monster_gold " +
                ") AS gold_table;";
    }
}
